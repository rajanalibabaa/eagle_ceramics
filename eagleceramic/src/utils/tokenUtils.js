export const setAdminToken = (token, extras = {}) => {
  ...
  try {
    ...
    if (parts.length === 3) {
      ...
      if (extractedEmail) data.brandDetails = { ...(data.brandDetails || {}), email: extractedEmail, id: extractedId || data.brandDetails?.id };
    }
  } catch (e) {
  ...
  if (extras.brandDetails) data.brandDetails = { ...(data.brandDetails || {}), ...extras.brandDetails };
