...
const ElevationCollection = [
  {
    ...
    hoverParagraph:
      "When the sun tries to cook your house, we hit back harder.300×300 mm | 10 mm thick | High SRI Cool Roof warriors in Plain Matt, Hexa Grip, Sugar Gloss.Light shades that laugh at heat and keep your home chill like a boss.",
              ...
              fallback={
                <Box
                  sx={{
                    ...
                    py: 8,
                    background:
                      "linear-gradient(45deg, rgba(255,215,0,0.1), rgba(1,107,97,0.1))",
                  }}
                >
                  <CircularProgress
                    size={60}
